...
- Join tokens are registration-only. A signed-in public join creates or repairs event membership and approved gallery access immediately; a signed-in private join creates or repairs event membership and a pending access request.
