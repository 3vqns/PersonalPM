...
- [frontend/src/pages/DashboardPage.tsx](/Users/tervin23/Documents/AG/PersonalPM/frontend/src/pages/DashboardPage.tsx): Lists registered events, supports favorites, tag filters, global event search, and a filter modal for searching event descriptions and tags by keyword.
...
- [frontend/src/pages/EventSettingsPage.tsx](/Users/tervin23/Documents/AG/PersonalPM/frontend/src/pages/EventSettingsPage.tsx): Lets event owners and admins update description, location, event thumbnail, and anonymous uploads. Only owners see the event deletion controls.
