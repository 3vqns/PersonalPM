...
def test_collect_best_photo_scores_deduplicates_across_selfies_and_faces(monkeypatch) -> None:
    ...
    selfies = [
        FaceProfileImageRecord(
            ...
            cloudinary_url="https://res.cloudinary.com/demo/image/upload/v1/pictureme/face-profiles/user-1/01.jpg",
            sort_order=1,
            created_at=datetime(2026, 4, 18, tzinfo=timezone.utc),
        ),
        FaceProfileImageRecord(
            ...
            cloudinary_url="https://res.cloudinary.com/demo/image/upload/v1/pictureme/face-profiles/user-1/02.jpg",
            sort_order=2,
            created_at=datetime(2026, 4, 18, tzinfo=timezone.utc),
        ),
    ]
